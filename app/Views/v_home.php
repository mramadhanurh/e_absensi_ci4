    <div class="section bg-primary" id="user-section">
      <div id="user-detail">
        <div class="avatar">
          <img src="<?= base_url('') ?>/<?= $karyawan ['foto_karyawan'] ?>" alt="avatar" class="imaged w64 rounded" />
        </div>
        <div id="user-info">
    ...
    <div class="section mt-2" id="presence-section">
      ...
      <div class="presencetab mt-2">
        ...
        <div class="tab-content mt-2" style="margin-bottom: 100px">
            <a href="<?= base_url('Auth/logOut') ?>" class="btn btn-danger btn-sm btn-block"><i class="fas fa-sign-out-alt"></i> Logout</a>
        </div>
